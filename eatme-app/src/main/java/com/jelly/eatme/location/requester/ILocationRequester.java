package com.jelly.eatme.location.requester;
...
public interface ILocationRequester {
     ...
     */
    void requestLocationUpdates(long minTime, long minDistance, Criteria criteria, PendingIntent pendingIntent);
     ...
     */
    void requestPassiveLocationUpdates(long minTime, long minDistance, PendingIntent pendingIntent);
