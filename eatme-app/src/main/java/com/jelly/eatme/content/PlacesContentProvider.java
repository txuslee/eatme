package com.jelly.eatme.content;
...
public class PlacesContentProvider extends ContentProvider {
    ...
    private static final Logger Log = LoggerFactory.getLogger(PlacesContentProvider.class.getSimpleName());
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://com.jelly.eatme.provider.places/places");
    ...
    static {
        ...
        uriMatcher.addURI("com.jelly.eatme.provider.places", "places", PLACES);
        uriMatcher.addURI("com.jelly.eatme.provider.places", "places/*", PLACE_ID);
    }
    ...
    public boolean onCreate() {
        ...
        try {
            ...
            Log.debug("Database Opening exception");
            placesDB = null;
        }
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case PLACES:
                return "vnd.android.cursor.dir/vnd.jelly.place";
            case PLACE_ID:
                return "vnd.android.cursor.item/vnd.jelly.place";
            default:
    ...
    private static class PlacesDatabaseHelper extends SQLiteOpenHelper {
        ...
        public PlacesDatabaseHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
